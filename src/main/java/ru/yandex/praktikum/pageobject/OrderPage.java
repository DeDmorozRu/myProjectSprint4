...
public class OrderPage {
    ...
    public void chooseMetroStationByScroll() {
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(listMetroStation));
    ...
    public void chooseRentalPeriod(String periodOption) {
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfAllElementsLocatedBy(rentalPeriodOptions));
    ...
    public boolean finishOrder() {
        ...
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(confirmModal));
        driver.findElement(yesButton).click();
        WebElement successOrderModalElement = new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(successOrderModal));
        return successOrderModalElement.isDisplayed();
    }

    public void clickNextButton() {
        driver.findElement(nextButton).click();
        new WebDriverWait(driver, 10).until(ExpectedConditions.visibilityOfElementLocated(arriveDate));
    }
